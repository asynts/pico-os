...
PageAllocator::PageAllocator() {
  ...
  m_blocks[power_of_two(128 * KiB)] =
      reinterpret_cast<Block *>(__pico_ram_start + 128 * KiB);
  m_blocks[power_of_two(64 * KiB)] =
      reinterpret_cast<Block *>(__pico_ram_start + 64 * KiB);
  m_blocks[power_of_two(32 * KiB)] =
      reinterpret_cast<Block *>(__pico_ram_start + 32 * KiB);
  m_blocks[power_of_two(16 * KiB)] =
      reinterpret_cast<Block *>(__pico_ram_start + 16 * KiB);
  m_blocks[power_of_two(8 * KiB)] =
      reinterpret_cast<Block *>(__pico_ram_start + 8 * KiB);
