...
public:
  ...
  virtual u8 *allocate(usize, bool debug_override = true,
                       void *address = nullptr);
  virtual void deallocate(u8 *, bool debug_override = true,
                          void *address = nullptr);
  virtual u8 *reallocate(u8 *, usize, bool debug_override = true,
                         void *address = nullptr);

  void add_memory(Bytes bytes);
