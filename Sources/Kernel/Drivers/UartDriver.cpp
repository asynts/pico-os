...
DmaCtrl *dma_channel0_ctrl_trigger = reinterpret_cast<UartCtrl*>(DMA_BASE + DMA_CHANNEL0_CTRL_TRIGGER);

namespace Kernel::Drivers
{
    // FIXME: Get this from the page allocator.
    // FIXME: Align this to 1 KiB
    ...
    void UartDriver::configure_dma()
    {
        ...
        uptr read_addr = UART0_BASE + UART_DATA;

        // This address will be incremented and wraps around at 1 KiB.
        uptr write_addr = reinterpret_cast<uptr>(uart_buffer);
        ...
        // FIXME: I don't quite understand what this does.
        //        My understanding is, that it will keep going forever when we set irq_quiet=1.
        //        Or does it stop without raising an interrupt?
        control.irq_quiet = 0;
